...
build_llvm() {
  ...
  case $BUILD_TYPE in
    "normal")
      ...
      CMAKE_ARGS="$CMAKE_ARGS -DLLVM_ENABLE_RUNTIMES=compiler-rt"
      CMAKE_ARGS="$CMAKE_ARGS -DLLVM_ENABLE_PROJECTS=clang;lld"
      CMAKE_ARGS="$CMAKE_ARGS -DLLVM_EXTERNAL_PROJECTS=include-what-you-use"
      CMAKE_ARGS="$CMAKE_ARGS -DLLVM_EXTERNAL_INCLUDE_WHAT_YOU_USE_SOURCE_DIR=$LLVM_SOURCE/include-what-you-use"
    ...
    "tsan")
      ...
      CMAKE_ARGS="$CMAKE_ARGS -DLLVM_ENABLE_RUNTIMES=libcxx;libcxxabi"
